...
export class ChatHistoryService {
  ...
  async getHistoryForUser(userId: number, type: ChatType) {
    ...
    if (messages.length === 0 && type === ChatType.DOCUMENT) {
      ...
      Мен сіздің құжаттарды жасау бойынша жеке көмекшіңізбін. Менің міндетім — қажетті актіні немесе есепті жылдам әрі қатесіз дайындауға көмектесу.
      ...
      *   **Егер қандай құжат керегін білсеңіз:** Оның атауын жазыңыз.
          > *Мысал:* "Жұмыстарды қабылдау-тапсыру актісі керек"
      *   **Егер сенімді болмасаңыз:** Барлық қолжетімді нұсқаларды көрсетуді сұраңыз.
      ...
      Я ваш ассистент по созданию документов. Моя задача — помочь вам быстро и без ошибок подготовить нужный акт или отчет.
      ...
      *   **Если знаете, какой документ вам нужен:** Просто напишите его название.
          > *Пример:* "Нужен акт приема-передачи работ"
      *   **Если не уверены:** Попросите меня показать все доступные варианты.

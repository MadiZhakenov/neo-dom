...
export class InitialSchema1754301768927 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "password_hash" character varying NOT NULL, "tariff" character varying NOT NULL DEFAULT 'Базовый', "generation_count" integer NOT NULL DEFAULT '0', "last_generation_date" TIMESTAMP, "full_name" character varying, "phone" character varying, "role" character varying NOT NULL DEFAULT 'resident', "chat_state" "public"."users_chat_state_enum" NOT NULL DEFAULT 'idle', "pending_template_name" character varying, "pending_request_id" character varying, "subscription_expires_at" TIMESTAMP, "password_reset_token" character varying, "password_reset_expires" TIMESTAMP, "password_change_required" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "apartments" ("id" SERIAL NOT NULL, "number" character varying NOT NULL, "address" character varying, CONSTRAINT "UQ_24e51578ee2e8a8893c3e73dc98" UNIQUE ("number"), CONSTRAINT "PK_f6058e85d6d715dbe22b72fe722" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "chat_message" ("id" SERIAL NOT NULL, "role" "public"."chat_message_role_enum" NOT NULL, "content" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_3cc0d85193aade457d3077dd06b" PRIMARY KEY ("id"))`);
